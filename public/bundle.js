...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t = text(ctx.text);
    			attr(button, "class", "btn svelte-1vfhdsl");
    			button.disabled = ctx.disabled;
    			add_location(button, file, 17, 0, 271);

    			dispose = [
    				listen(button, "click", ctx.callback),
    ...
    function instance($$self, $$props, $$invalidate) {
        ...
        let { disabled = false, text = 'click' } = $$props;

        console.log(text);

    	const writable_props = ['callback', 'disabled', 'text'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console_1.warn(`<Button> was created with unknown prop '${key}'`);
    	});
    	...
    	return { callback, disabled, text, click_handler };
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	var button1 = new Button({
    		props: { text: "Unregister" },
    		$$inline: true
    	});

    	var button2 = new Button({ props: { text: "Call" }, $$inline: true });
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$1, 15, 4, 169);
    			attr(input, "type", "text");
    			attr(input, "class", "number");
    			add_location(input, file$1, 17, 4, 206);
    			attr(div1, "class", "time");
    			add_location(div1, file$1, 21, 4, 274);
    			attr(div2, "class", "status");
    			add_location(div2, file$1, 23, 4, 308);
    			add_location(div3, file$1, 10, 0, 87);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(label_1, file$2, 17, 4, 220);
    			attr(input, "type", "text");
    			attr(input, "class", "input svelte-usnrj9");
    			attr(input, "name", ctx.label);
    			add_location(input, file$2, 18, 4, 259);
    			attr(div, "class", "field svelte-usnrj9");
    			add_location(div, file$2, 16, 0, 196);
    ...
    function create_fragment$3(ctx) {
    	...
    	var button = new Button({ props: { text: "Save" }, $$inline: true });
    	...
    	return {
    		c: function create() {
    			...
    			t4 = space();
    			button.$$.fragment.c();
    			add_location(div, file$3, 10, 0, 167);
    		},
    ...
    const file$5 = "src/Logger.svelte";

    function create_fragment$5(ctx) {
    	var div4, div0, t0, div3, div1, t1, div2, current;

    	var button = new Button({ props: { text: "Clear" }, $$inline: true });
    	...
    	return {
    		c: function create() {
    			...
    			t1 = space();
    			div2 = element("div");
    			attr(div0, "class", "logger-btn svelte-16mfpne");
    			add_location(div0, file$5, 36, 4, 581);
    			attr(div1, "class", "incoming svelte-16mfpne");
    			add_location(div1, file$5, 40, 8, 682);
    			attr(div2, "class", "outgoing svelte-16mfpne");
    			add_location(div2, file$5, 44, 8, 738);
    			attr(div3, "class", "logger svelte-16mfpne");
    			add_location(div3, file$5, 39, 4, 653);
    			attr(div4, "class", "logger-wrapper svelte-16mfpne");
    			add_location(div4, file$5, 35, 0, 548);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t = space();
    			logger.$$.fragment.c();
    			attr(div, "class", "app-wrapper svelte-nbmbrp");
    			add_location(div, file$6, 15, 0, 192);
    		},
